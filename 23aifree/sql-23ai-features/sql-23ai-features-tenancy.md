...
## Task 1: FROM clause - now optional
...
## Task 3: IF [NOT] EXISTS DDL clause
...
## Task 5: New table value constructor
...
## Task 6: Aliases in GROUP BY clause
...
## Task 7: RETURNING clause of UPDATE and MERGE statement
...
## Task 8: Joins in UPDATE and DELETE
...
## Task 9: Annotations, new metadata for database objects
...
## Task 10: "Light weight object types" with SQL Domains
